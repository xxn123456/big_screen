  ...
  <div class="user">
    ...
    <div class="info">
      <el-form ref="ruleForm" :model="form" :rules="freeRules">
        <el-form-item label="账号：" :label-width="formLabelWidth" prop="oldPassword">
          <span>{{ form.roleName }}</span>
        </el-form-item>
        <el-form-item label="旧密码：" :label-width="formLabelWidth" prop="oldPassword">
          <el-input v-model="form.oldPassword" placeholder="请输入内容" show-password />
        </el-form-item>
        <!-- 校验密码逻辑 -->
        <el-form-item label="新密码：" :label-width="formLabelWidth" prop="password">
          <el-input v-model="form.password" placeholder="请输入内容" show-password />
        </el-form-item>
        <el-form-item label="确认密码：" :label-width="formLabelWidth" prop="checkPassword">
          <el-input v-model="form.checkPassword" placeholder="请输入内容" show-password />
        </el-form-item>
      </el-form>
    </div>

    <div class="btns">
      <el-button type="primary" size="small" round @click="changePassWord">提交信息</el-button>
    </div>
    ...
    getUserAbout() {
      return new Promise((resolve, reject) => {
        ...
        getUserAbout(msg).then((res) => {
          ...
          this.form = {
            userId: respData.id,
            roleName: respData.ov.roles[0].roleName,
            oldPassword: '',
            password: '',
            checkPassword: '',
            salt: ''
