  ...
  <div class="table-wrap">
    ...
    <div class="table-main">
      ...
      <el-table :data="tableData" style="width: 100%" :header-cell-style="{background:'#eef1f6',color:'#606266'}"
        ...
        <el-table-column prop="role_router" label="菜单权限" width="180" align="left" :formatter="Tableformatter">
        </el-table-column>

         <el-table-column prop="role_screen" label="大屏权限" width="180" align="left" :formatter="Tableformatter">
        </el-table-column>
